...
import classes from './watermelonUpdate.module.css';
import UpdateSpinner from '../updateSpinner/updateSpinner';


class UpdateWatermelon extends React.Component {
    state = {
        imageUrl: "",
        name: "",
        price: "",
    ...
    updateOrderHandler = () => {
        ...
        axiosInstance.put(`/order/watermelon/${this.props.watermelonId}/watermelonItems.json`, update)
            .then(response => {
...
export default withRouter(UpdateWatermelon);