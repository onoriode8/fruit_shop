...
import classes from './orangeUpdate.module.css';
import UpdateSpinner from '../updateSpinner/updateSpinner';


class UpdateOrange extends React.Component {
    state = {
        imageUrl: "",
        name: "",
        price: "",
    ...
    updateOrderHandler = () => {
        ...
        axiosInstance.put(`/order/orange/${this.props.orangeId}/orangeItems.json`, update)
            .then(response => {
...
export default withRouter(UpdateOrange);