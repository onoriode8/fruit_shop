...
import classes from './strawberryUpdate.module.css';
import UpdateSpinner from '../updateSpinner/updateSpinner';


class UpdateStrawberry extends React.Component {
    state = {
        imageUrl: "",
        name: "",
        price: "",
    ...
    updateOrderHandler = () => {
        ...
        axiosInstance.put(`/order/strawberry/${this.props.strawberryId}/strawberryItems.json`, update)
            .then(response => {
...
export default withRouter(UpdateStrawberry);